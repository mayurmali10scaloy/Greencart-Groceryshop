...
function AddUser({ closeModal, refreshUsers, showMsg }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (refreshUsers) {
        refreshUsers();
        showMsg("User added successfully!", "add");
        closeModal();
      } else {
        nav("/AdminPanel/Users", {
          state: { msg: "User added successfully!", type: "add" },
        });
      }
    } catch (err) {
      console.error("Add User Error:", err);
      const errorMsg = err.response?.data?.message || err.response?.data?.error || "Failed to add user";
        ...
        <div className="modal-header-bar">
          <div className="modal-header-left">
            ...
            <div>
              ...
              <p className="modal-subtitle">Fill in the details below to create a user</p>
            </div>
          </div>
          <Link
            className="modal-close-btn"
            onClick={closeModal ? closeModal : () => nav(-1)}
            to={closeModal ? "/AdminPanel/Users" : "#"}
            title="Close"
            ...
            <div className="modal-col-1">
              ...
              <div className="form-grid single">
                <div className="field-group">
                  ...
                  <input type="text" className={`field-input ${errors.userName ? "has-error" : ""}`} placeholder="Enter username"
                ...
                <div className="field-group">
                  ...
                  <input type="email" className={`field-input ${errors.email ? "has-error" : ""}`} placeholder="Enter email"
                ...
                <div className="field-group">
                  ...
                  <input type="password" className={`field-input ${errors.password ? "has-error" : ""}`} placeholder="min 6 characters"
                ...
                <div className="field-group">
                  ...
                  <input type="text" className={`field-input ${errors.mobileNo ? "has-error" : ""}`} placeholder="10 digit number"
            ...
            <div className="modal-col-2">
              ...
              <div className="form-grid single">
                ...
                <div className="field-group">
                  ...
                  <input type="text" className="field-input" placeholder="Street address"
                    value={user.address} onChange={set("address")} />
                </div>

                <div className="field-group">
                  <label className="field-label">City</label>
                  <input type="text" className="field-input" placeholder="City name"
                    value={user.city} onChange={set("city")} />
                </div>

                <div className="field-group">
                  <label className="field-label">Pincode</label>
                  <input type="text" className={`field-input ${errors.pincode ? "has-error" : ""}`} placeholder="6 digit code"
        ...
        <div className="modal-footer-bar">
          ...
          <div className="modal-footer-actions">
            ...
            <button type="submit" className="btn-save" disabled={converting}>
              {converting ? <><i className="fa-solid fa-spinner fa-spin"></i> Processing...</> : "Create User"}
            </button>
          </div>
        </div>
